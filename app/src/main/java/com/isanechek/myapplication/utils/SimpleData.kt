...
object SimpleData {
    ...
    fun initModel(): MutableList<Banner> {
        val modules = ArrayList<Banner>()
        modules.add(Banner(IMAGE_URL_1, TITLE_1))
        modules.add(Banner(IMAGE_URL_2, TITLE_2))
        modules.add(Banner(IMAGE_URL_3, TITLE_3))
